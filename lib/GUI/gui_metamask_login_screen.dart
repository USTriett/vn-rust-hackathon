...
class GUIMatamaskScreen extends StatefulWidget {
  const GUIMatamaskScreen({
    required this.title,
  ...
  @override
  State<GUIMatamaskScreen> createState() => _GUIMatamaskScreenState();
}

class _GUIMatamaskScreenState extends State<GUIMatamaskScreen> {
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Text(
                                      'You can login your metamask wallet from here',
